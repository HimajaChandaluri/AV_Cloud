...
class SensorInfo extends Component {
  state = {
    tailight: "", headlight: "", temperature: "",
};
  ...
  reRenderAV = (data) => {
      ...
      this.setState({ tailight: data.tailight, headlight: data.headlight, temperature: data.temperature});
      ...
      return (
        <React.Fragment>
          ...
          <div class="sensor" style={{
            ...
            marginBottom: "100px",
            marginTop: '100px',
          }} >Tailight Status:  {this.state.tailight}</h2>
            <h2 style={{
            marginBottom: "100px",
            marginTop: '100px',
            textAlign: 'center',
          }}>Headlight Status:  {this.state.headlight}</h2>
